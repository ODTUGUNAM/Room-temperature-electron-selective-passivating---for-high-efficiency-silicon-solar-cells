...
2. Open the relevant SCAPS file (typical vs champion) in **SCAPS**.
3. Run the simulation to reproduce the JV fit and use the provided parameter sets as a starting point for comparisons or sensitivity sweeps.
